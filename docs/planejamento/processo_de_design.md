...
<div style="text-align: center">
    <p> No ciclo de vida simples (Figura 1), o processo é dividido em design (ou redesign) e na construção de uma versão interativa. A interação entre as atividades do processo pode acontecer diversas vezes alternando entre uma nova versão, e sua avaliação partindo para o redesign e assim sucessivamente até o término do projeto.</p>
</div>
...
<div style="text-align: center">
    <p> <b>Figura 1: </b> Ciclo de vida de simples (Fonte: [1]).</p>
    <p> Esse ciclo de vida é mais indicado para designers experientes, muito embora seja um ciclo de vida simples para entender,o fator baixo nível de detalhamento das atividades dificulta para iniciantes. </p>
</div>
