...
| Descrição do problema: Na aba de projetos, os nomes de cada subitem é de uma natureza infamiliar com o usuário comum. |
...
Tabela 4 - Formulário de Avaliação Heurística do Ponto 4 (Fonte: Lucas Gobbi, 2023)
