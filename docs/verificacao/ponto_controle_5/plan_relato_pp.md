...
# Verificação do artefato de Planejamento do Relato dos Resultados da Avaliação do Protótipo de Papel do Grupo 3
...
Este artefato tem como objetivo realizar a verificação do artefato do Planejamento do Relato dos Resultados da Avaliação do Protótipo de Papel do Grupo 3.
...
| 3 | O artefato descreve a atividade a ser realizada (no caso o relato dos resultados da avaliação)? | Sim | Excelente | -|
| 4 | O artefato descreve quando serão realizadas as correções dos protótipos? | Não | - | O artefato não descreve quando serão realizadas as alterações no protótipo de papel. |
| 5 | O artefato demanda o roteiro da simulação? | Sim | Excelente | - |
...
- id4: O artefato deveria descrever/planejar quando serão realizadas as evoluções do protótipo de papel;
- id8: O artefato deveria descrever como os problemas encontrados nas simulações serão descritos no relato.

A seguir, segue um gráfico (figura 1) representativo do conteúdo da tabela 1:

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-VideoLAN/main/docs/img/verificacao/plan_relato_pp.png" width="100%">
...
- Documento do Planejamento do Relato dos Resultados do Protótipo de Papel do Grupo 3 da Disciplina de Interação Humano Computador. Disponível em: https://interacao-humano-computador.github.io/2023.1-BancoCentral/#/design_prototipo/prototipo_papel/planejamento_relato. Acesso em: 16 jun. 2023.
...
| :-: | :-: | :-: | :-: | :-: | :-: |
| 16/06/2023 | `1.0` | Criação do artefato |  [Igor Penha](https://github.com/igorpenhaa) e [Lucas Gobbi](https://github.com/lucasbergholz) | 18/06/2023 | [Bruno Ribeiro](https://github.com/brunoriibeiro) |
