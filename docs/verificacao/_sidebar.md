...
- [Ponto de controle 1](#)
    ...
    - [Sites Avaliados](verificacao/ponto_controle_1/sites_avaliados.md)
    - [Site Selecionado](verificacao/ponto_controle_1/site_selecionado.md)
    - [Projeto de Design](verificacao/ponto_controle_1/processo_design.md)
- [Ponto de controle 2](#)

    - [Perfil de Usuário](verificacao/ponto_controle_2/perfil_usuario.md)
...
- [Ponto de controle 4](#)
    ...
    - [Planejamento da Avaliação da Análise de Tarefas](verificacao/ponto_controle_4/plan_aval_at.md)
    - [Planejamento do Relato dos Resultados da Análise de Tarefas](verificacao/ponto_controle_4/plan_relato_at.md)
    - [Planejamento da Avaliação do StoryBoard](verificacao/ponto_controle_4/plan_aval_st.md)
    - [Planejamento do Relato dos Resultados do StoryBoard](verificacao/ponto_controle_4/plan_relato_st.md)
- [Ponto de controle 5](#)

    - [Relato Resultados da Análise de Tarefas](verificacao/ponto_controle_5/resultados_at.md)
    - [Relato Resultados do Storyboad](verificacao/ponto_controle_5/resultados_st.md)
    - [Planejamento da Avaliação do Protótipo de Papel](verificacao/ponto_controle_5/plan_aval_pp.md)
