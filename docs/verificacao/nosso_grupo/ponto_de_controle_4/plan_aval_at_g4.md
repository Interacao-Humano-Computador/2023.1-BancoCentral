...
<p>O artefato em questão tem como objetivo detalhar o planejamento da avaliação do artefato análise de tarefas, o artefato em questão deve seguir o padrão que o artefato planejamento da avaliação do análise de tarefas sugere, tendo em vista que o <a href="https://github.com/Interacao-Humano-Computador/2023.1-BancoCentral/blob/master/docs/design_prototipo/analise_tarefas/planejamento_relato.md">Planejamento do Relato da Análise de Trefas</a>, deve servir como uma base, para construir uma avaliação consistente.</p>
...
| 10 | A respeito das perguntas, elas possuem o objetivo de sua escolha? | Sim | Bom | A disposição do objetivo que as perguntas devem cumprir está confuso, estão no tópico objeto do framework |
| 11 | Foi apresentado um método para realização da atividade proposta? | Sim | Excelente | --- |
| 12 | O termo de consentimento foi apresentado? | Não | --- | Apenas foi citado que ele foi utilizado, porém não foi mostrado explicitamente. |
...
| 17 | Apresenta um cronograma para realização das tarefas propostas, incluindo entrevistas e teste piloto? | Sim | Excelente | --- |
...
| 20 | A respeito da coleta de dados, apresenta como eles serão armazenados, avaliados, separados e ordnados? | Não | --- | Não apresenta um detalhamento quanto aos dados. |
...
<h4><p>10 - A respeito das perguntas, elas possuem o objetivo de sua escolha?</p></h4>
<p>O motivo foi apresentado, porém a disposição dos elementos está confusa.</p>
<h4><p>12 - O termo de consentimento foi apresentado?</p></h4>
<p> Carece da explicitação de um termo de consentimento, apenas foi citado.</p>
