...
# Verificação de Ferramentas do Grupo 3 (Banco Central do Brasil)
...
Este artefato tem como objetivo realizar a verificação do artefato de ferramentas versã0 `1.4` do Grupo 3.
...
| - | - | - | - | - |
| 1 | O artefato possui o objetivo do documento? | Não |  | O documento só aprensenta uma pequena introdução. |
| 2 | O artefato apresenta uma introdução?  | Sim | Excelente |  |
| 3 | O artefato prevê todas as ferramenta que serão utilizadas no projeto? | Não |  | Existem ferramentas as quais não estão apresentadas no artefato. |
| 4 | O artefato especifica onde cada ferramenta será utilizada e qual sua finalidade para o projeto? | Sim | Excelente |  |
| 5 | São apresentadas as logos de cada ferramenta? | Sim | Excelente  |  |
...
- Redigir um objetivo para o artefato.
- Adicionar todas as ferramentas utilizadas no projeto.
