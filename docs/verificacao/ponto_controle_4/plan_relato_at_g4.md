...
| - | - | - | - |
| O artefato possui o objetivo do documento? | Sim | Excelente | Foi dada uma boa descrição do objetivo para a realização da avaliação do storyboard. |
| O artefato possui a metodologia utilizada e sua respectiva descrição? | Sim | Incompleta | O artefato apresenta a metodologia da realização da avaliação do storyboard, porém falta informações importantes, de como o processo será realizado, além das informações sobre a metodologia estarem espalhadas no texto. |
...
| O artefato descreve sobre o objetivo do relato da avaliação do storyboard?| Sim | Boa | O artefato descreve o objetivo com clareza, no entanto faltou um pouco mais de detalhamento sobre o objetivos que devem ser estabelecidos. |
| O artefato apresenta um plano de documentação das respostas para uma analise dos resultados? | Não | --- | O artefato não apresenta um plano de documentação das respostas, como elas serão documentadas, como serão organizadas?. |
...
O artefato, em sua grande maioria, está mediano com o que se espera dele, falta informações sobre o plano de realização das atividades detalhadamente, assim como falta dados sobre como será documentado, armazenado e organizado as respostas do respondente, tal como será registrado a reunião com ele.
