window.$docsify.plugins=[].concat((e,o)=>{
    let t={
        ...
        light:{
            accent:"#42b983",toogleBackground:"#091a28",
            background:"#ffffff",
            textColor:"#34495e",
    ...
    e.afterEach((function(e,o){o(e='<div id="docsify-darklight-theme"><p>.</p></div>'+e)})),e.doneEach((function(){
        ...
        null!==o&&o.addEventListener("click",(function(){"light"===t.defaultTheme?d("dark"):d("light")}))
    }))
},
