...
<div align="justify"> O site permite que o usuário tenha uma clara noção das intenções e ações possíveis, além de deixar bem explícito o efeito que cada ação terá no sistema. Podemos ver um exemplo dessa clareza de ação e reação que o site entrega na Figura 1, nela é possível observar que tarefas que levam o usuário para outra lista de opções possuem uma seta apontando para direita e funções que redirecionam o usuário não possuem essa seta.
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/expectativa_usuario.png">
  
<div align="center">
  <p> <b>Figura 1</b>: Clareza de navegabilidade do site Banco Central do Brasil (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>
...
<div align="justify"> Norman (1988) recomenda simpliﬁcar a estrutura das tarefas, reduzindo a quantidade de planejamento e resolução de problemas que elas requerem. Porém no site do Banco Central do Brasil, existem ainda algumas tarefas que para o usuário concluir exigem muitas etapas, como por exemplo, o acesso a um curso, como pode ser análisado no artefato de <a href="docs/analise_requisitos/analise_tarefas.md">Análise de tarefas</a>. Outro exemplo pode ser a dificuldade na navegação pelos menus so site, pois apresenta uma série de etapas que devem ser realizadas para encontrar uma funcionalidade, como pode ser visto na Figura 2. 

<br>

<p align="justify">A Figura 2 apresenta a navegabilidade do site do Banco Cental do Brasil.</p>
...
<div align="center">
  <p> <b>Figura 2</b>: Navegabilidade do site Banco Central do Brasil (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>

<br>

<div align="justify">Além da dificuldade em realizar algumas etapas podemos também citar quanto a simplicidade, a página inicial do site do banco do brasil, pois apresenta uma quantidade grande de informações, como pode ser visto na Figura 3, poluindo a interface e podendo desencorajar novos usuários do sistema.
</div>

<br>

<p align="justify">A Figura 3 apresenta o excesso de informação do site do Banco Cental do Brasil.</p>
...
<div align="center">
  <p> <b>Figura 3</b>: Excesso de informação do site do Banco Cental do Brasil (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>
...
<div align="justify"> O site do Banco Central do Brasil possui um layout bem padronizado e ícones bem explicativos, o que fazem com que o usuário tenha um aprendizado mais efetivo e navegabilidade fique mais fluida. Assim como é possível observar nas Figuras 4 e 5 a seguir, o sistema do Banco Central do Brasil mantem um padrão de ícones tanto no site quanto nas aplicações mobile que o Banco possui, o que colabora com a navegabilidade do usuário.
</div>
<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/aplicativo_calculadora_cidadao.jpg">
  
<div align="center">
  <p> <b>Figura 4</b>: Aplicativo da Calculadora do Cidadão (Fonte: Aplicativo Calculadora do Cidadão). </p>
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/site_calculadora_cidadao.png">
  
<div align="center">
  <p> <b>Figura 5</b>: Calculadora do Cidadão no Site do Banco Central (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>

<div align="justify">Porém, não é sempre que o sistema do Banco Central do Brasil consegue manter um padrão de layout perfeito, como no caso da avaliação de notas da segunda geração do Real, onde no site foram utilizadas algumas cores e no aplicativo do Dinheiro Brasileiro foram utilizadas outras. Assim como é possível ver nas Figuras 6 e 7.
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/aplicativo_notas.jpg">
  
<div align="center">
  <p> <b>Figura 6</b>: Avaliação de notas dentro do Aplicativo Dinheiro Brasileiro (Fonte: Aplicativo Dinheiro Brasileiro). </p>
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/site_notas.png">
  
<div align="center">
  <p> <b>Figura 7</b>: Avaliação de notas dentro do site do Banco Central (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>
...
<div align="justify">Além de tais problemas pode também ser visto como um, a navegabilidade nos menus do site, pois podem ser muito custosas, como visto na Figura 2, e às vezes pouco intuitiva ainda mais para novos usuários, dessa forma a eficiência do usuário pode ser comprometida em detrimento do excesso de informação e organização dos dados que o site oferece.
</div>

<br>

<div align="justify">Porém, o usuário pode realizar o login em um serviço do Banco Central chamado Registrato, nesse serviço as alterações que o usuário realizar serão salvas, podemos ver a interface abaixo, na Figura 8 e 9.
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/login_registrato.png">
  
<div align="center">
  <p> <b>Figura 8</b>: Interface de login no Registrato pelo GOV.br (Fonte: <a href="https://sso.acesso.gov.br/login?client_id=registrato.bcb.gov.br&authorization_id=1884ba3cf6a">Login Registrato</a>). </p>
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/area_registrato.png">
  
<div align="center">
  <p> <b>Figura 9</b>: Interface do Registrato (Fonte: <a href="https://registrato.bcb.gov.br/registrato/relatorios">Registrato</a>). </p>
</div>

<br>

<div align="justify">Além disso, como pode ser observado na Figura 10, o site do Banco Central possui algumas ferramentas para auxiliar na eficiência do usuário, como por exemplo a barra de fluxo de telas apresentada abaixo, que pode orientar o usuário de onde ele esta no site e como voltar atrás em alguma decisão.
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/eficiencia_usuario.png">
  
<div align="center">
  <p> <b>Figura 10</b>: Interface do site com barra de auxílio ao usuário (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>
...
<div align="justify"> Porém o site possui algumas funções na aba superior que foram planejadas para antecipar necessidades do usuário, como por exemplo a parte representada pelo número 1 na Figura 11, onde o usuário pode opter por acessibilidade, modo escuro e mudar o idioma. Além disso, o site ainda oferece a opção de pesquisa ao usuário ao clicar na lupa também representada na imagem.
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/antecipando_usuario.png">
  
<div align="center">
  <p> <b>Figura 11</b>: Funções que Antecipam Necessidades (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>

- ### Visibilidade e reconhecimento:

<div align="justify"> O site do Banco Central do Brasil possui ícones bem padronizados e intuitivos sobre que tarefas eles representam, o que permite que o usuário tenha uma navegabilidade facilitada. Como é possível observar na Figura 12, a seguir, na qual os icones são compatíveis com as tarefas que representam.
</div>

<br>

<img src="https://raw.githubusercontent.com/Interacao-Humano-Computador/2023.1-BancoCentral/master/docs/img/prin_gerais/icones_intuitivos.png">
  
<div align="center">
  <p> <b>Figura 12</b>: Ícones Intuitivos (Fonte: <a href="https://www.bcb.gov.br/">Banco Central do Brasil</a>). </p>
</div>
...
<div align="justify"> O site do Banco Central do Brasil apresenta aos usuários expressões formais e padrões adequados de comunicação. E quando o site utiliza termos mais avançados ou específicos, o sistema oferece formas de acessar conteúdos que explicam tais termos, como por exemplo a aba de Acesso a Informações representada pelo número 2 na Figura 11 acima.
</div>
