...
O artefato em questão é um documento que reúne os protótipos de papel desenvolvidos para o Banco Central, juntamente com os relatos e melhorias resultantes de reuniões com os clientes. Esse documento é uma peça fundamental no processo de design e desenvolvimento de produtos, pois permite a visualização e validação das ideias de forma tangível antes da implementação.
...
<div align="center">
<p> Tabela 4: Questões respondidas na entrevista (Fonte: GOMES, Larissa 2023).</p>
</div>
